...
export function EmailDetail({ email, onBack }: EmailDetailProps) {
  ...
  return (
    <div className="flex h-screen overflow-hidden bg-slate-50">
      ...
      <div className="flex-1 flex flex-col overflow-hidden border-r border-slate-200 bg-white">
        ...
        <div className="border-b border-slate-200 p-6 bg-white">
          <Button
            variant="ghost"
            onClick={onBack}
            className="gap-2 mb-6 text-slate-600 hover:text-slate-900 hover:bg-slate-100 -ml-2"
          >
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-3 mb-2">
                <h3 className="text-xl font-semibold text-slate-900">{email.studentName}</h3>
                <Badge variant="outline" className="text-slate-600 bg-slate-50 border-slate-300">
                  Junior, CS Major
                </Badge>
              </div>
              <p className="text-sm text-slate-500 mb-3">{email.timestamp}</p>
              <h2 className="text-lg font-medium text-slate-800 mb-4 leading-tight">{email.subject}</h2>
        ...
        <div className="flex-1 overflow-y-auto p-8">
          <div className="w-full max-w-none">
            {/* Email Body */}
            <div className="bg-white rounded-xl p-10 mb-10 border border-slate-200 shadow-sm">
            ...
            <div className="border border-slate-200 rounded-xl p-8 bg-white shadow-sm">
              <button 
                ...
                className="flex items-center gap-4 text-slate-600 hover:text-slate-900 w-full p-3 rounded-lg hover:bg-blue-50 transition-colors"
              >
                <FileText className="w-6 h-6" />
                <span className="font-medium text-lg">{showPreviousMessages ? 'Hide' : 'View'} previous messages (2)</span>
              </button>
        ...
        <div className="border-t border-slate-200 p-8 bg-white">
          <div className="flex gap-4 w-full">
            <Button 
              ...
              className="gap-3 bg-primary-600 hover:bg-primary-700 text-white px-8 py-4 font-medium shadow-sm text-base"
            >
            ...
            <Button 
              ...
              variant="outline" 
              className="gap-3 px-8 py-4 font-medium border-slate-300 hover:bg-blue-50 text-base"
            >
      ...
      <div className="w-[480px] flex flex-col overflow-hidden bg-white border-l border-slate-200">
        <div className="border-b border-slate-200 p-8 bg-gradient-to-r from-blue-50 to-purple-50">
          ...
          <p className="text-base text-slate-600">Powered by Gemini</p>
        </div>

        <Tabs value={activeTab} onValueChange={setActiveTab} className="flex-1 flex flex-col">
          <TabsList className="w-full justify-start rounded-none border-b border-slate-200 px-8 py-5 bg-white">
            <TabsTrigger value="summary" className="px-6 py-3 text-base">Summary</TabsTrigger>
            <TabsTrigger value="draft" className="px-6 py-3 text-base">Draft Reply</TabsTrigger>
            <TabsTrigger value="policies" className="px-6 py-3 text-base">Policies</TabsTrigger>
          </TabsList>

          <div className="flex-1 overflow-y-auto">
            <TabsContent value="summary" className="p-8 space-y-8 m-0">
              {/* AI Summary */}
              <div className="bg-gradient-to-br from-blue-50 to-purple-50 rounded-xl p-7 border border-blue-200 shadow-sm">
                <h4 className="mb-4 flex items-center gap-3 font-semibold text-slate-900 text-lg">
                  <Sparkles className="w-5 h-5 text-primary-600" />
                  AI-Generated Summary
                </h4>
                <p className="text-slate-700 leading-relaxed text-base">{email.summary}</p>
              </div>

              {/* Key Insights */}
              <div>
                <h4 className="mb-6 font-semibold text-slate-900 text-lg">Key Insights</h4>
              ...
              {/* Hidden Intent */}
              <div>
                <h4 className="mb-6 font-semibold text-slate-900 text-lg">Detected Patterns</h4>
            ...
            <TabsContent value="draft" className="p-8 space-y-8 m-0">
              <div className="bg-green-50 border border-green-200 rounded-xl p-6 flex items-start gap-4 shadow-sm">
                <Sparkles className="w-6 h-6 text-green-600 mt-0.5 flex-shrink-0" />
                <p className="text-green-800 font-medium leading-relaxed text-base">
              ...
              <Textarea
                value={draftReply}
                readOnly
                className="min-h-[400px] bg-white resize-none border-slate-300 shadow-sm rounded-xl text-base p-6"
              />

              <div className="space-y-4">
                <Button onClick={handleRefreshSuggestions} variant="outline" className="w-full gap-3 py-4 text-base border-slate-300 hover:bg-blue-50">
                  <RefreshCw className="w-5 h-5" />
                  Regenerate Draft
                </Button>
                <Button onClick={handleCopyDraft} variant="outline" className="w-full gap-3 py-4 text-base border-slate-300 hover:bg-blue-50">
                  <Copy className="w-5 h-5" />
                  Copy to Clipboard
                </Button>
                <Button onClick={handleGenerateReply} className="w-full gap-3 py-4 text-base bg-primary-600 hover:bg-primary-700 text-white font-medium shadow-sm">
                  <Send className="w-5 h-5" />
                  Insert into Outlook
                </Button>
              </div>
            ...
            <TabsContent value="policies" className="p-8 space-y-8 m-0">
              <div>
                <h4 className="mb-6 flex items-center gap-3 font-semibold text-slate-900 text-lg">
                ...
                <div className="space-y-6">
                  {email.category === 'extension' && (
                    <div className="bg-white border border-slate-200 rounded-xl p-7 shadow-sm">
                      <h4 className="text-primary-700 mb-4 font-semibold text-base">Late Submission Policy</h4>
                  ...
                  {email.category === 'grades' && (
                    <div className="bg-white border border-slate-200 rounded-xl p-7 shadow-sm">
                      <h4 className="text-primary-700 mb-4 font-semibold text-base">Grade Appeal Process</h4>
                      <p className="text-slate-600 leading-relaxed text-base">
                  ...
                  <div className="bg-white border border-slate-200 rounded-xl p-7 shadow-sm">
                    <h4 className="text-primary-700 mb-4 font-semibold text-base">Communication Guidelines</h4>
                    <p className="text-slate-600 leading-relaxed text-base">
              ...
              <div>
                <h4 className="mb-6 font-semibold text-slate-900 text-lg">Draft Alignment</h4>
                <div className="bg-green-50 border border-green-200 rounded-xl p-7 shadow-sm">
                  <div className="space-y-3 text-green-800 font-medium text-base">
